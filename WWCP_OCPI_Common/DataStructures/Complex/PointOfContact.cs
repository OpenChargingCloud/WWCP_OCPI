...
namespace cloud.charging.open.protocols.OCPI
{
    ...
    /// <summary>
    /// Point of contact (OCPI v3 feature).
    /// </summary>
                                  ...
                                  IComparable
    {
        ...
        /// </summary>
        public static readonly JSONLDContext DefaultJSONLDContext = JSONLDContext.Parse("https://open.charging.cloud/contexts/OCPI/pointOfContact");
        ...
        #region (static) TryParse(JSON, out PointOfContact, out ErrorResponse, ...)
