...
namespace cloud.charging.open.protocols.OCPI
{
    ...
    public readonly struct Module_Id : IId<Module_Id>
    {
        ...
        /// The bookings module.
        /// </summary>
        public static Module_Id  Bookings            { get; }
            = new ("bookings");
        ...
        /// </summary>
        public static Module_Id EVSEStatuses             { get; }
            = new ("evsestatuses");

        /// <summary>
        /// The Invoice Reconciliation module.
        /// </summary>
        public static Module_Id InvoiceReconciliation    { get; }
            = new ("irrs");

        /// <summary>
        /// The Power Regulation module.
        /// </summary>
        public static Module_Id PowerRegulation          { get; }
            = new ("meterreadings");

        /// <summary>
        /// The Tariff Assocations module.
        /// </summary>
        public static Module_Id TariffAssocations        { get; }
