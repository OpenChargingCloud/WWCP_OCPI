...
namespace cloud.charging.open.protocols.OCPI
{
    ...
    public readonly struct EnergyContract_Id : IId<EnergyContract_Id>
    {
        ...
        #region (static) NewRandom (Length = 60)

        /// <summary>
        /// Create a new random energy contract identification.
        /// </summary>
        /// <param name="Length">The expected length of the energy contract identification.</param>
        public static EnergyContract_Id NewRandom(Byte Length = 60)
