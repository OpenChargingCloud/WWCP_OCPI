...
namespace cloud.charging.open.protocols.OCPI
{
    ...
    public readonly struct InvoiceReference_Id : IId<InvoiceReference_Id>
    {
        ...
        #region (static) NewRandom (Length = 39)

        /// <summary>
        /// Create a new random invoice reference.
        /// </summary>
        /// <param name="Length">The expected length of the invoice reference.</param>
        public static InvoiceReference_Id NewRandom(Byte Length = 39)
