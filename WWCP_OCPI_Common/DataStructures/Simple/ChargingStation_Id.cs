 ...
 *
 * Licensed under the Apache License, ChargingStation 2.0 (the "License");
...
namespace cloud.charging.open.protocols.OCPI
{
    ...
    public readonly struct ChargingStation_Id : IId<ChargingStation_Id>
    {
        ...
        /// </summary>
        /// <param name="Text">The text representation of a charging station identification.</param>
        ...
        /// <summary>
        /// Parse the given text as a charging station identification.
        /// </summary>
        ...
        /// <summary>
        /// Try to parse the given text as a charging station identification.
        /// </summary>
        /// <param name="Text">A text representation of a charging station identification.</param>
