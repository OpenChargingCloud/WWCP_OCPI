...
namespace cloud.charging.open.protocols.OCPIv2_1_1
{
    ...
    public static class OCPIMapper
    {
        ...
        public static IEnumerable<Facility> ToOCPI(this IEnumerable<WWCP.Facility> Facilities)
        {
            ...
            foreach (var facility in Facilities)
            {
                ...
                switch (facility.ToString())
                {
                    ...
                    case "HOTEL":           facilities.Add(OCPIv2_1_1.Facility.HOTEL);            break;
                    case "RESTAURANT":      facilities.Add(OCPIv2_1_1.Facility.RESTAURANT);       break;
                    case "CAFE":            facilities.Add(OCPIv2_1_1.Facility.CAFE);             break;
                    case "MALL":            facilities.Add(OCPIv2_1_1.Facility.MALL);             break;
                    case "SUPERMARKET":     facilities.Add(OCPIv2_1_1.Facility.SUPERMARKET);      break;
                    case "SPORT":           facilities.Add(OCPIv2_1_1.Facility.SPORT);            break;
                    case "RECREATION_AREA": facilities.Add(OCPIv2_1_1.Facility.RECREATION_AREA);  break;
                    case "NATURE":          facilities.Add(OCPIv2_1_1.Facility.NATURE);           break;
                    case "MUSEUM":          facilities.Add(OCPIv2_1_1.Facility.MUSEUM);           break;
                    case "BIKE_SHARING":    facilities.Add(OCPIv2_1_1.Facility.BIKE_SHARING);     break;
                    case "BUS_STOP":        facilities.Add(OCPIv2_1_1.Facility.BUS_STOP);         break;
                    case "TAXI_STAND":      facilities.Add(OCPIv2_1_1.Facility.TAXI_STAND);       break;
                    case "TRAM_STOP":       facilities.Add(OCPIv2_1_1.Facility.TRAM_STOP);        break;
                    case "METRO_STATION":   facilities.Add(OCPIv2_1_1.Facility.METRO_STATION);    break;
                    case "TRAIN_STATION":   facilities.Add(OCPIv2_1_1.Facility.TRAIN_STATION);    break;
                    case "AIRPORT":         facilities.Add(OCPIv2_1_1.Facility.AIRPORT);          break;
                    case "PARKING_LOT":     facilities.Add(OCPIv2_1_1.Facility.PARKING_LOT);      break;
                    case "CARPOOL_PARKING": facilities.Add(OCPIv2_1_1.Facility.CARPOOL_PARKING);  break;
                    case "FUEL_STATION":    facilities.Add(OCPIv2_1_1.Facility.FUEL_STATION);     break;
                    case "WIFI":            facilities.Add(OCPIv2_1_1.Facility.WIFI);             break;
                                                   ...
                                                   ref List<Warning>                                                             Warnings)
        {
            ...
            var locations = ChargingPools.ToOCPI(
                                CustomChargingPoolIdConverter,
                                CustomEVSEUIdConverter,
                                CustomEVSEIdConverter,
                                IncludeEVSEIds,
                                                   ...
                                                   out IEnumerable<Warning>                                                      Warnings)
        {
            ...
            foreach (var chargingPool in ChargingPools)
            {
                ...
                try
                {
                    ...
                    var chargingPool2 = chargingPool.ToOCPI(
                                            CustomChargingPoolIdConverter,
                                            CustomEVSEUIdConverter,
                                            CustomEVSEIdConverter,
                                            IncludeEVSEIds,
