                ...
                for (const evse of location.evses) {
                    ...
                    if (evse.connectors) {
                        for (var connector of evse.connectors) {
                            ...
                            connectorInfoDiv.innerHTML        = connector.id + ". " + connector.standard + ", " + connector.format + ", " + connector.max_amperage + " A, " + connector.max_voltage + " V, " + (connector.max_electric_power/1000) + " kW, " + connector.power_type;
