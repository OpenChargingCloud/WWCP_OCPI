    ...
    public class EMSPAPI : GenericAPI
    {
        ...
        public EMSPAPI(RoamingNetwork    RoamingNetwork,
            ...
            : base(RoamingNetwork,
                   ...
                   URIPrefix,
                   ResourceName => typeof(EMSPAPI).Assembly.GetManifestResourceStream("org.GraphDefined.WWCP.OCPI_2_0.HTTPAPI.EMSPAPI.HTTPRoot." + ResourceName),

                   ServiceName,
                   APIEMailAddress,
                   null,//OpenPGP.ReadPublicKeyRing(typeof(EMSPAPI).Assembly.GetManifestResourceStream("org.GraphDefined.WWCP.OCPI_2_0.HTTPAPI.GenericAPI.HTTPRoot.robot@offenes-jena_pubring.gpg")),
                   APISecretKeyRing,
                   APIPassphrase,
                   APIAdminEMail,
                   APISMTPClient,
        ...
        public EMSPAPI(RoamingNetwork    RoamingNetwork,
            ...
            : base(RoamingNetwork,
                   ...
                   ServiceName,
                   APIEMailAddress,
                   OpenPGP.ReadPublicKeyRing(typeof(EMSPAPI).Assembly.GetManifestResourceStream("org.GraphDefined.WWCP.OCPI_2_0.HTTPAPI.EMSPAPI.HTTPRoot.About.robot@offenes-jena_pubring.gpg")),
                   APISecretKeyRing,
                   APIPassphrase,
                   APIAdminEMail,
                   APISMTPClient,
        ...
        private void RegisterEMSPURITemplates()
        {
            ...
            _HTTPServer.RegisterResourcesFolder(URIPrefix + "/emsp", "org.GraphDefined.WWCP.OCPI_2_0.HTTPAPI.EMSPAPI.HTTPRoot", Assembly.GetCallingAssembly());
            ...
            _HTTPServer.AddMethodCallback(HTTPMethod.GET,
                                          ...
                                          HTTPDelegate: HTTPRequest => {
                                              ...
                                              typeof(EMSPAPI).Assembly.GetManifestResourceStream("org.GraphDefined.WWCP.OCPI_2_0.HTTPAPI.EMSPAPI.HTTPRoot._header.html").SeekAndCopyTo(_MemoryStream, 3);
                                              typeof(EMSPAPI).Assembly.GetManifestResourceStream("org.GraphDefined.WWCP.OCPI_2_0.HTTPAPI.EMSPAPI.HTTPRoot._footer.html").SeekAndCopyTo(_MemoryStream, 3);
