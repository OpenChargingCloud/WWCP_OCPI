...
namespace org.GraphDefined.WWCP
{
...

    {
        ...
        public Location_Id Clone
        {
            get
            {
                return new Location_Id(InternalId);
            }
        }
        ...
        public static Boolean operator == (Location_Id LocationId1, Location_Id LocationId2)
        {
            ...
            if (ReferenceEquals(LocationId1, LocationId2))
                return true;
        ...
        public Int32 CompareTo(Location_Id LocationId)
        {
            ...
            if (_Result == 0)
                _Result = InternalId.CompareTo(LocationId.InternalId);
        ...
        public Boolean Equals(Location_Id LocationId)
        {
            ...
            return InternalId.Equals(LocationId.InternalId);
