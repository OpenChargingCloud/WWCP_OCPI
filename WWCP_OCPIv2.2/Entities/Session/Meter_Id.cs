...
namespace org.GraphDefined.WWCP
{
...

    {
        ...
        public Meter_Id Clone
        {
            get
            {
                return new Meter_Id(InternalId);
            }
        }
        ...
        public static Boolean operator == (Meter_Id MeterId1, Meter_Id MeterId2)
        {
            ...
            if (ReferenceEquals(MeterId1, MeterId2))
                return true;
        ...
        public Int32 CompareTo(Meter_Id MeterId)
        {
            ...
            if (_Result == 0)
                _Result = InternalId.CompareTo(MeterId.InternalId);
        ...
        public Boolean Equals(Meter_Id MeterId)
        {
            ...
            return InternalId.Equals(MeterId.InternalId);
