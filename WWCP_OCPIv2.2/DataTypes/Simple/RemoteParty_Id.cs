...
namespace cloud.charging.open.protocols.OCPIv2_2
{
    ...
    public readonly struct RemoteParty_Id : IId<RemoteParty_Id>
    {
        ...
        /// </summary>
        /// <param name="String">The string representation of the remote party identification.</param>
        private RemoteParty_Id(String String)
        {
        ...
        public static Boolean TryParse(String Text, out RemoteParty_Id RemotePartyId)
        {
            ...
            if (Text.IsNotNullOrEmpty())
            {
                try
                {
                    RemotePartyId = new RemoteParty_Id(Text.Trim());
                    return true;
                }
                catch (Exception)
                { }
