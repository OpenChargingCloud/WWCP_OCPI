...
namespace cloud.charging.open.protocols.OCPIv2_2_1.CPO.HUB.HTTP
{
    ...
    public partial class CPO2HUB_HTTPClient : IHTTPClient
    {
        ...
        /// <summary>
        /// The CPO2HUB HTTP client logger.
        /// </summary>
        public new sealed class HTTPClientLogger : CommonHTTPClient.HTTPClientLogger
        {
            ...
            /// </summary>
            public new const String  DefaultContext   = $"OCPI{Version.String}_CPO2HUB_HTTPClient";
            ...
            /// <summary>
            /// The attached CPO2HUB HTTP client.
            /// </summary>
            public CPO2HUB_HTTPClient  Client    { get; }
            ...
            /// <summary>
            /// Create a new CPO2HUB HTTP client logger using the default logging delegates.
            /// </summary>
            /// <param name="Client">A CPO2HUB HTTP client.</param>
            /// <param name="LoggingPath">The logging path.</param>
            /// <param name="Context">A context of this API.</param>
            /// <param name="LogfileCreator">A delegate to create a log file from the given context and log file name.</param>
            public HTTPClientLogger(CPO2HUB_HTTPClient          Client,
                                    String?                      LoggingPath,
...

            {
                ...
                this.Client = Client ?? throw new ArgumentNullException(nameof(Client), "The given CPO2HUB HTTP client must not be null!");
