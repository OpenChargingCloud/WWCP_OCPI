...
namespace cloud.charging.open.protocols.OCPIv2_2_1.CPO.HUB.HTTP
{
    ...
    /// </summary>
    public partial class CPO2HUB_HTTPClient : CommonHTTPClient
    {
        ...
        /// </summary>
        public new const String  DefaultHTTPUserAgent    = $"GraphDefined OCPI {Version.String} {nameof(CPO2HUB_HTTPClient)}";

        /// <summary>
        /// The default logging context.
        /// </summary>
        public new const String  DefaultLoggingContext   = nameof(CPO2HUB_HTTPClient);
        ...
        /// <summary>
        /// Create a new CPO2HUB HTTP client.
        /// </summary>
        ...
        public CPO2HUB_HTTPClient(CPO_HTTPAPI                                               CPO_HTTPAPI,
        ...
        // A CPO wants to send an update towards a HUB or SCSP: https://github.com/ocpi/ocpi/blob/release-2.2.1-bugfixes/mod_charging_profiles.asciidoc
        ...
        public override JObject ToJSON()
            => base.ToJSON(nameof(CPO2HUB_HTTPClient));
