...
namespace cloud.charging.open.protocols.OCPIv2_3_0.HTTP
{
    ...
    public static class CPOAPIExtensions
    {
                                            ...
                                            Boolean                                    FailOnMissingLocation = true)
        {
            ...
            {
                if (CPOAPI.CommonAPI.TryGetLocation(countryCodeWithPartyId.Item1,
                                          ...
                                          out OCPIResponse.Builder?                  OCPIResponseBuilder)
        {
            ...
            foreach (var countryCodeWithPartyId in CountryCodesWithPartyIds)
            {
                if (CPOAPI.CommonAPI.TryGetTariff(countryCodeWithPartyId.Item1,
                                                  countryCodeWithPartyId.Item2,
                                                  TariffId.Value,
                                                  out Tariff))
                {
                                           ...
                                           out OCPIResponse.Builder?                  OCPIResponseBuilder)
        {
            ...
            foreach (var countryCodeWithPartyId in CountryCodesWithPartyIds)
            {
                if (CPOAPI.CommonAPI.TryGetSession(countryCodeWithPartyId.Item1,
                                                   countryCodeWithPartyId.Item2,
                                                   SessionId.Value,
                                                   out Session))
                {
                                       ...
                                       out OCPIResponse.Builder?                  OCPIResponseBuilder)
        {
            ...
            foreach (var countryCodeWithPartyId in CountryCodesWithPartyIds)
            {
                if (CPOAPI.CommonAPI.TryGetCDR(countryCodeWithPartyId.Item1,
                                               countryCodeWithPartyId.Item2,
                                               CDRId.Value,
                                               out CDR))
                {
    ...
    public class CPOAPI : HTTPAPI
    {
        ...
        private void RegisterURLTemplates()
        {
            ...
            //                                   URLPathPrefix + "/cpo", "cloud.charging.open.protocols.OCPIv2_3_0.HTTPAPI.CPOAPI.HTTPRoot",
            ...
            //                                 typeof(CPOAPI).Assembly.GetManifestResourceStream("cloud.charging.open.protocols.OCPIv2_3_0.HTTPAPI.CPOAPI.HTTPRoot._header.html").SeekAndCopyTo(_MemoryStream, 3);
            //                                 typeof(CPOAPI).Assembly.GetManifestResourceStream("cloud.charging.open.protocols.OCPIv2_3_0.HTTPAPI.CPOAPI.HTTPRoot._footer.html").SeekAndCopyTo(_MemoryStream, 3);
