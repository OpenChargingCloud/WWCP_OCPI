...
namespace cloud.charging.open.protocols.OCPIv2_3_0
{
    ...
    public class CPO_HTTPAPI : AHTTPExtAPIExtension2<CommonAPI, HTTPExtAPI>
    {
        ...
        public CustomJObjectSerializerDelegate<Booking>?                     CustomBookingSerializer                       { get; set; }
        ...
        public class HTTP_Events
        {
            ...
            #region (protected internal) GetBookingsHTTPRequest  (Request)

            /// <summary>
            /// An event sent whenever a GET Bookings HTTP request was received.
            /// </summary>
            public OCPIRequestLogEvent OnGetBookingsHTTPRequest = new();
            ...
            #region (protected internal) GetBookingsHTTPResponse (Response)

            /// <summary>
            /// An event sent whenever a GET Bookings HTTP response was sent.
            /// </summary>
            public OCPIResponseLogEvent OnGetBookingsHTTPResponse = new();
            ...
            #region (protected internal) PostBookingHTTPRequest  (Request)

            /// <summary>
            /// An event sent whenever a POST Booking HTTP request was received.
            /// </summary>
            public OCPIRequestLogEvent OnPostBookingHTTPRequest = new();
            ...
            #region (protected internal) PostBookingHTTPResponse (Response)

            /// <summary>
            /// An event sent whenever a POST Booking HTTP response was sent.
            /// </summary>
            public OCPIResponseLogEvent OnPostBookingHTTPResponse = new();
            ...
            #region (protected internal) GetTerminalHTTPRequest   (Request)

            /// <summary>
            /// An event sent whenever a GET terminal HTTP request was received.
            /// </summary>
            public OCPIRequestLogEvent OnGetTerminalHTTPRequest = new();
            ...
            #region (protected internal) GetTerminalHTTPResponse  (Response)

            /// <summary>
            /// An event sent whenever a GET terminal HTTP response was sent.
            /// </summary>
            public OCPIResponseLogEvent OnGetTerminalHTTPResponse = new();
            ...
            #region (protected internal) PostTerminalHTTPRequest  (Request)

            /// <summary>
            /// An event sent whenever a POST terminal HTTP request was received.
            /// </summary>
            public OCPIRequestLogEvent OnPostTerminalHTTPRequest = new();
            ...
            #region (protected internal) PostTerminalHTTPResponse (Response)

            /// <summary>
            /// An event sent whenever a POST terminal HTTP response was sent.
            /// </summary>
            public OCPIResponseLogEvent OnPostTerminalHTTPResponse = new();
                ...
                if      (OCPIHTTPRequest.LocalAccessInfo.Is(Role.EMSP))
                {
                    ...
                    if (emspClient is not null)
                    {
                        ...
                        var httpClient    = new HTTPClient(
                                                ...
                                                InternalBufferSize:                    emspClient.InternalBufferSize,
                ...
                else if (OCPIHTTPRequest.LocalAccessInfo.Is(Role.HUB))
                {
                    ...
                    if (hubClient is not null)
                    {
                        ...
                        var httpClient    = new HTTPClient(
                                                ...
                                                InternalBufferSize:                    hubClient.InternalBufferSize,
        ...
        private void RegisterURLTemplates()
        {
            ...
            // https://example.com/ocpi/2.3.0/cpo/tariffs/?date_from=2019-01-28T12:00:00&date_to=2019-01-29T12:00:00&offset=50&limit=100
            CommonAPI.AddOCPIMethod(
            ...
            CommonAPI.AddOCPIMethod(
                ...
                HTTPMethod.GET,
                URLPathPrefix + "bookings",
                HTTPEvents.GetBookingsHTTPRequest,
                HTTPEvents.GetBookingsHTTPResponse,
                request => {
            ...
            CommonAPI.AddOCPIMethod(
                ...
                HTTPMethod.POST,
                URLPathPrefix + "commands/NOTIFY_WEB_PAYMENT_STARTED",
                HTTPEvents.NotifyWebPaymentsStartedHTTPRequest,
                HTTPEvents.NotifyWebPaymentsStartedHTTPResponse,
                async request => {
            ...
            CommonAPI.AddOCPIMethod(
                ...
                HTTPMethod.POST,
                URLPathPrefix + "commands/NOTIFY_WEB_PAYMENT_FAILED",
                HTTPEvents.NotifyWebPaymentsFailedHTTPRequest,
                HTTPEvents.NotifyWebPaymentsFailedHTTPResponse,
                async request => {
            ...
            CommonAPI.AddOCPIMethod(
                ...
                HTTPMethod.GET,
                URLPathPrefix + "payments/terminals/{terminalId}",
                HTTPEvents.GetTerminalHTTPRequest,
                HTTPEvents.GetTerminalHTTPResponse,
                request => {
            ...
            CommonAPI.AddOCPIMethod(
                ...
                HTTPMethod.POST,
                URLPathPrefix + "payments/terminals/{terminalId}",
                HTTPEvents.PostTerminalHTTPRequest,
                HTTPEvents.PostTerminalHTTPResponse,
                async request => {
                        ...
                        request.LocalAccessInfo?.Status != AccessStatus.ALLOWED)
                    {
                        ...
                        return new OCPIResponse.Builder(request) {
                                   ...
                                   HTTPResponseBuilder  = new HTTPResponse.Builder(request.HTTPRequest) {
                                       HTTPStatusCode             = HTTPStatusCode.Forbidden,
                                       AccessControlAllowMethods  = [ HTTPMethod.OPTIONS, HTTPMethod.GET, HTTPMethod.POST, HTTPMethod.PATCH ],
                                       AccessControlAllowHeaders  = [ "Authorization" ]
                                   }
                               };
                    ...
                    return new OCPIResponse.Builder(request) {
                               StatusCode           = StatusCode.ClientErrors.GenericClientError,
                               StatusMessage        = addOrUpdateResult.ErrorResponse,
                               Data                 = newOrUpdatedTerminal.ToJSON(
                                                          true,
                                                          true,
                                                          CustomTerminalSerializer,
                                                          CustomDisplayTextSerializer,
