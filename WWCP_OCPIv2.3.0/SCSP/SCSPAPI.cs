...
namespace cloud.charging.open.protocols.OCPIv2_3_0
{
    ...
    /// </summary>
    public class SCSPAPI : AHTTPExtAPIExtension2<CommonAPI, HTTPExtAPI>
    {
        ...
        /// </summary>
        public new static readonly HTTPPath  DefaultURLPathPrefix      = HTTPPath.Parse("/scsp");
        ...
        private void RegisterURLTemplates()
        {
            ...
            //                                   URLPathPrefix + "/emsp", "cloud.charging.open.protocols.OCPIv2_3_0API.SCSPAPI.HTTPRoot",
            ...
            //                                 typeof(SCSPAPI).Assembly.GetManifestResourceStream("cloud.charging.open.protocols.OCPIv2_3_0API.SCSPAPI.HTTPRoot._header.html").SeekAndCopyTo(_MemoryStream, 3);
            //                                 typeof(SCSPAPI).Assembly.GetManifestResourceStream("cloud.charging.open.protocols.OCPIv2_3_0API.SCSPAPI.HTTPRoot._footer.html").SeekAndCopyTo(_MemoryStream, 3);
                                ...
                                Data                 = new JArray(
                                                           filteredLocations.
                                                               SkipTakeFilter(filters.Offset,
                                                                              filters.Limit).
                                                               Select(location => location.ToJSON(request.RemoteParty?.Id,
                ...
                request => {
                    ...
                    return Task.FromResult(
                        new OCPIResponse.Builder(request) {
                               StatusCode           = StatusCode.Success,
                               StatusMessage        = "Hello world!",
                               Data                 = location.ToJSON(request.RemoteParty?.Id,
                                                                      CustomLocationSerializer,
                                                                      CustomPublishTokenSerializer,
                                                                      CustomAdditionalGeoLocationSerializer,
                                                                      CustomEVSESerializer,
                ...
                async request => {
                    ...
                    if (addOrUpdateResult.IsSuccessAndDataNotNull(out var data))
                    {
                        ...
                        return new OCPIResponse.Builder(request) {
                                   StatusCode           = StatusCode.Success,
                                   StatusMessage        = "Hello world!",
                                   Data                 = data.ToJSON(request.RemoteParty?.Id,
                                                                      CustomLocationSerializer,
                                                                      CustomPublishTokenSerializer,
                                                                      CustomAdditionalGeoLocationSerializer,
                                                                      CustomEVSESerializer,
                    ...
                    return new OCPIResponse.Builder(request) {
                               ...
                               Data                 = newOrUpdatedLocation.ToJSON(request.RemoteParty?.Id,
                                                                                  CustomLocationSerializer,
                                                                                  CustomPublishTokenSerializer,
                                                                                  CustomAdditionalGeoLocationSerializer,
                                                                                  CustomEVSESerializer,
