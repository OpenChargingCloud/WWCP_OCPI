    ...
    public class HUB_HTTPAPI : AHTTPExtAPIXExtension2<CommonAPI, HTTPExtAPIX>
    {
        ...
        private void RegisterURLTemplates()
        {
            ...
            CommonAPI.AddOCPIMethod(
                ...
                //                                                                                   filters.Limit).
                //                                                                    SafeSelect(location => location.ToJSON(request.RemoteParty?.Id,
            ...
            // https://example.com/ocpi/2.3.0/cpo/tokens/?date_from=2019-01-28T12:00:00&date_to=2019-01-29T12:00:00&offset=50&limit=100
            CommonAPI.AddOCPIMethod(
                ...
                async request => {
                    ...
                    await foreach (var postTokenTask in Task.WhenEach(postTokenTasks))
                    {
                        ...
                        try
                        {
                            ...
                            if (postTokenResult.StatusCode    == StatusCode.Success &&
