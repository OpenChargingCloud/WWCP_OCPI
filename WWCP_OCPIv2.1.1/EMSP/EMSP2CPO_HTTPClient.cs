...
namespace cloud.charging.open.protocols.OCPIv2_1_1.EMSP.HTTP
{
    ...
    public partial class EMSP2CPO_HTTPClient : CommonHTTPClient
    {
        ...
        /// <param name="TariffTimestamp">An optional timestamp for time-traveled requests.</param>
                ...
                if (httpClient is not null)
                {
                    ...
                    var httpResponse = await httpClient.GET(
                                                 ...
                                                 RequestBuilder:        requestBuilder => {
                                                                            ...
                                                                            if (TariffTimestamp.HasValue)
                                                                                requestBuilder.QueryString.Add("timestamp", TariffTimestamp.Value.ToISO8601());
...

        {
            ...
            {
                DebugX.LogException(e, nameof(EMSP2CPO_HTTPClient) + "." + nameof(OnReserveNowResponse));
            }
...

        {
            ...
            {
                DebugX.LogException(e, nameof(EMSP2CPO_HTTPClient) + "." + nameof(OnUnlockConnectorRequest));
            }
