...

        {
            ...
            try
            {
                    ...
                    VersionDetails.TryGetValue(versionId.Value, out VersionDetail versionDetails))
                {
                    ...
                    LocationsURL = versionDetails.Endpoints.FirstOrDefault(endpoint => endpoint.Identifier == ModuleIDs.Locations).URL;
...

        {
            ...
            try
            {
                    ...
                    VersionDetails.TryGetValue(versionId.Value, out VersionDetail versionDetails))
                {
                    ...
                    TariffsURL = versionDetails.Endpoints.FirstOrDefault(endpoint => endpoint.Identifier == ModuleIDs.Tariffs).URL;
...

        {
            ...
            try
            {
                    ...
                    VersionDetails.TryGetValue(versionId.Value, out VersionDetail versionDetails))
                {
                    ...
                    SessionsURL  = versionDetails.Endpoints.FirstOrDefault(endpoint => endpoint.Identifier == ModuleIDs.Sessions).URL;
...

        {
            ...
            try
            {
                    ...
                    VersionDetails.TryGetValue(versionId.Value, out VersionDetail versionDetails))
                {
                    ...
                    CDRsURL = versionDetails.Endpoints.FirstOrDefault(endpoint => endpoint.Identifier == ModuleIDs.CDRs).URL;
