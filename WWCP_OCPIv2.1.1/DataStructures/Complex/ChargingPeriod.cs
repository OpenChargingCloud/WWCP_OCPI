...
namespace cloud.charging.open.protocols.OCPIv2_1_1
{
    ...
    //public static class ChargingPeriodExtensions
    //{

    //    public static IEnumerable<ChargingPeriod> AsChargingPeriods(this IEnumerable<ChargingPeriod> ChargingPeriods)
