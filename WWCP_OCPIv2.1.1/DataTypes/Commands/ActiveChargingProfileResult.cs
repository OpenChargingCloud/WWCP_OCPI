...
namespace cloud.charging.open.protocols.OCPIv2_1_1
{
                                                         ...
                                                         IComparable
    {
        ...
        #region (static) Parse   (Text, CustomActiveChargingProfileResultParser = null)

        /// <summary>
        /// Parse the given text representation of an active charging profile result.
        /// </summary>
        /// <param name="Text">The text to parse.</param>
        /// <param name="CustomActiveChargingProfileResultParser">A delegate to parse custom active charging profile result JSON objects.</param>
        public static ActiveChargingProfileResult Parse(String                                                    Text,
                                                        CustomJObjectParserDelegate<ActiveChargingProfileResult>  CustomActiveChargingProfileResultParser   = null)
        {
            ...
            throw new ArgumentException("The given text representation of an active charging profile result is invalid: " + ErrorResponse, nameof(Text));

        }

        #endregion

        #region (static) TryParse(JSON, CustomActiveChargingProfileResultParser = null)
        ...
        /// <param name="JSON">The JSON to parse.</param>
        /// <param name="CustomActiveChargingProfileResultParser">A delegate to parse custom active charging profile result JSON objects.</param>
        public static ActiveChargingProfileResult? TryParse(JObject                                                   JSON,
                                                            CustomJObjectParserDelegate<ActiveChargingProfileResult>  CustomActiveChargingProfileResultParser   = null)
        {
        ...
        #region (static) TryParse(Text, CustomActiveChargingProfileResultParser = null)
        ...
        /// <param name="CustomActiveChargingProfileResultParser">A delegate to parse custom active charging profile result JSON objects.</param>
        public static ActiveChargingProfileResult? TryParse(String                                                    Text,
                                                            CustomJObjectParserDelegate<ActiveChargingProfileResult>  CustomActiveChargingProfileResultParser   = null)
        {
                                       ...
                                       CustomJObjectParserDelegate<ActiveChargingProfileResult>  CustomActiveChargingProfileResultParser   = null)
        {
            ...
            try
            {
                ...
                if (CustomActiveChargingProfileResultParser != null)
        ...
        #region (static) TryParse(Text, out ActiveChargingProfileResult, out ErrorResponse, CustomActiveChargingProfileResultParser = null)

        /// <summary>
        /// Try to parse the given text representation of an active charging profile result.
        /// </summary>
        /// <param name="Text">The text to parse.</param>
        /// <param name="ActiveChargingProfileResult">The parsed charging profileResponse.</param>
        /// <param name="ErrorResponse">An optional error response.</param>
        /// <param name="CustomActiveChargingProfileResultParser">A delegate to parse custom active charging profile result JSON objects.</param>
                                       ...
                                       CustomJObjectParserDelegate<ActiveChargingProfileResult>  CustomActiveChargingProfileResultParser   = null)
        {
            ...
            {
                ActiveChargingProfileResult  = default;
                ErrorResponse                = "The given text representation of an active charging profile result is invalid: " + e.Message;
                return false;
            }
                              ...
                              CustomJObjectSerializerDelegate<ChargingProfilePeriod>        CustomChargingProfilePeriodSerializer         = null)
        {
            ...
            var JSON = JSONObject.Create(
                           ...
                           Profile.HasValue
                               ? new JProperty("profile",  Profile.Value.ToJSON(CustomActiveChargingProfileSerializer,
            ...
            return CustomActiveChargingProfileResultSerializer != null
        ...
        public static Boolean operator != (ActiveChargingProfileResult ActiveChargingProfileResult1,
            ...
            => !(ActiveChargingProfileResult1 == ActiveChargingProfileResult2);
        ...
        /// Compares two instances of this object.
        /// </summary>
        /// <param name="ActiveChargingProfileResult">An object to compare with.</param>
        public Int32 CompareTo(ActiveChargingProfileResult ActiveChargingProfileResult)
        {
            ...
            if (c == 0 && Profile.HasValue && ActiveChargingProfileResult.Profile.HasValue)
                c = Profile.Value.CompareTo(ActiveChargingProfileResult.Profile.Value);
        ...
        public Boolean Equals(ActiveChargingProfileResult ActiveChargingProfileResult)
            ...
            => Result. Equals(ActiveChargingProfileResult.Result) &&
               Profile.Equals(ActiveChargingProfileResult.Profile);
