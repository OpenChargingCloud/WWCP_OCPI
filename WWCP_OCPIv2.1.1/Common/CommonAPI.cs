...
namespace cloud.charging.open.protocols.OCPIv2_1_1
{
    ...
    public class CommonAPI : AHTTPExtAPIExtension1<HTTPExtAPI>
    {
        ...
        private async Task<OCPIResponse.Builder> POSTOrPUTCredentials(OCPIRequest Request)
        {
            ...
            if (otherVersion2_1_1Details.StatusCode != StatusCode.Success)
                return new OCPIResponse.Builder(Request) {
        ...
        public async Task<RemoveResult<IEnumerable<Location>>>
            ...
            RemoveAllLocations(CountryCode        CountryCode,
                               Party_Id           PartyId,
                               Boolean            SkipNotifications   = false,
                               EventTracking_Id?  EventTrackingId     = null,
                               User_Id?           CurrentUserId       = null,
                               CancellationToken  CancellationToken   = default)
        {
            ...
            foreach (var location in locations.Values)
            {
                if (location.CountryCode == CountryCode && location.PartyId == PartyId)
                    matchingLocations.Add(location);
            }
        ...
        public async Task<AddResult<EVSE>>

            AddEVSE(Location           Location,
                    EVSE               EVSE,
                    Boolean            SkipNotifications   = false,
                    EventTracking_Id?  EventTrackingId     = null,
                    User_Id?           CurrentUserId       = null,
...

        {
            ...
            var newLocation = Location.Update(
                                  locationBuilder => {
        ...
        public async Task<AddResult<EVSE>>
            ...
            AddEVSEIfNotExists(Location           Location,
                               EVSE               EVSE,
                               Boolean            SkipNotifications   = false,
                               EventTracking_Id?  EventTrackingId     = null,
                               User_Id?           CurrentUserId       = null,
        ...
        public async Task<UpdateResult<EVSE>>

            UpdateEVSE(Location           Location,
                       EVSE               EVSE,
                       Boolean?           AllowDowngrades     = false,
                       Boolean            SkipNotifications   = false,
                       EventTracking_Id?  EventTrackingId     = null,
                       ...
                       CancellationToken  CancellationToken   = default)
        {
            ...
            if (newLocation is null)
                return UpdateResult<EVSE>.Failed(
                           EventTrackingId,
                           EVSE,
                           warnings.First().Text.FirstText()
                       );
                         ...
                         CancellationToken  CancellationToken   = default)
        {
            ...
            if (!EVSEPatch.HasValues)
                return PatchResult<EVSE>.Failed(
                           EventTrackingId,
                           EVSE,
            ...
            if (patchResult.IsSuccessAndDataNotNull(out var patchedEVSE))
            {
                                                                   ...
                                                                   CancellationToken  CancellationToken   = default)
        {
            ...
            if (newEVSE is null)
                return UpdateResult<Connector>.Failed(
                           EventTrackingId,
                           Connector,
                           warnings.First().Text.FirstText()
                       );
                                                                    ...
                                                                    CancellationToken  CancellationToken   = default)
        {
            ...
            if (!ConnectorPatch.HasValues)
                return PatchResult<Connector>.Failed(
                           EventTrackingId,
                           Connector,
            ...
            if (patchResult.IsSuccessAndDataNotNull(out var patchedConnector))
            {
