...
function StartTariffs() {
    ...
    const numberOfTariffsDiv = locationInfosDiv.querySelector("#numberOfTariffs");
        ...
        try {
            ...
            if ((ocpiResponse === null || ocpiResponse === void 0 ? void 0 : ocpiResponse.data) != undefined &&
                ...
                for (const tariff of ocpiResponse.data) {
                    totalNumberOfEVSEs++;
                    const tariffDiv = locationsDiv.appendChild(document.createElement('div'));
                    ...
                    for (const tariffElement of tariff.elements) {
                        ...
                        for (const priceComponent of tariffElement.price_components) {
                            ...
                            const priceComponentTypeDiv = priceComponentsDiv.appendChild(document.createElement('div'));
                            priceComponentTypeDiv.className = "priceComponentType";
                            priceComponentTypeDiv.innerHTML = priceComponent.type.toString();
                            const priceComponentPriceDiv = priceComponentsDiv.appendChild(document.createElement('div'));
                            priceComponentPriceDiv.className = "priceComponentPrice";
                            priceComponentPriceDiv.innerHTML = priceComponent.price.toString();
                            const priceComponentStepSizeDiv = priceComponentsDiv.appendChild(document.createElement('div'));
