    ...
    public class WebAPI_JSON_Tests : ANodeTests
    {
        ...
        public async Task WebAPI_GetRemoteParties_Test()
        {
                ...
                emsp1VersionsAPIURL.HasValue)
            {
                ...
                var baseURL   = emsp1VersionsAPIURL.Value.ToString().Replace(emsp1VersionsAPIURL.Value.Path.ToString(), emsp1WebAPI.HTTPBaseAPI.URLPathPrefix.ToString());
                var response  = await TestHelpers.GetJSONArrayRequest(URL.Parse(baseURL) + "remoteParties");
                ...
                emsp2VersionsAPIURL.HasValue)
            {
                ...
                var baseURL   = emsp2VersionsAPIURL.Value.ToString().Replace(emsp2VersionsAPIURL.Value.Path.ToString(), emsp2WebAPI.HTTPBaseAPI.URLPathPrefix.ToString());
                var response  = await TestHelpers.GetJSONArrayRequest(URL.Parse(baseURL) + "remoteParties");
