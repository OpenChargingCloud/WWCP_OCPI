...
namespace cloud.charging.open.protocols.OCPIv3_0
{
    ...
    /// A charging station.
    /// </summary>
    public class ChargingStation : APartyIssuedObject3<ChargingStation_Id, Location>,
                                   ...
                                   IEnumerable<EVSE>
    {
                                       ...
                                       CustomJObjectParserDelegate<ChargingStation>?  CustomChargingStationParser   = null)
        {
            ...
            try
            {
                ...
                if (JSON.ParseOptionalJSON("energy_meter",
                                           "energy meter",
                                           EnergyMeter<ChargingStation>.TryParse,
                                           out EnergyMeter<ChargingStation>? EnergyMeter,
                                           out ErrorResponse))
                {
                    if (ErrorResponse is not null)
                        return false;
        ...
        #region CalcSHA256Hash(CustomChargingStationSerializer = null, CustomEVSESerializer = null, ...)
        ...
        /// <summary>
        /// Return a builder for this charging station.
        /// </summary>
        /// <param name="NewChargingStationId">An optional new charging station identification.</param>
        public Builder ToBuilder(ChargingStation_Id? NewChargingStationId = null)

            => new (

                   ParentLocation,
                   NewChargingStationId ?? Id,
