...
//    /// </summary>
//    public class EMSPAPI : AHTTPExtAPIXExtension2<CommonAPI, HTTPExtAPI>
//    {
...
//            //                                   URLPathPrefix + "/emsp", "cloud.charging.open.protocols.OCPIv3_0API.EMSPAPI.HTTPRoot",
...
//            //                                 typeof(EMSPAPI).Assembly.GetManifestResourceStream("cloud.charging.open.protocols.OCPIv3_0API.EMSPAPI.HTTPRoot._header.html").SeekAndCopyTo(_MemoryStream, 3);
//            //                                 typeof(EMSPAPI).Assembly.GetManifestResourceStream("cloud.charging.open.protocols.OCPIv3_0API.EMSPAPI.HTTPRoot._footer.html").SeekAndCopyTo(_MemoryStream, 3);
...
//                                        var allLocations       = CommonAPI.GetLocations(partyId).ToArray();
...
//                                        //ToDo: await...
//                                        CommonAPI.RemoveAllLocations(partyId!.Value);
...
//                                        //ToDo: await...
//                                        await CommonAPI.RemoveLocation(partyId.Value, location);
...
//            //                            if (!Request.ParseLocationChargingStationEVSEConnector(this,
//            //                                                                    out var countryCode,
//            //                                                                    out var partyId,
//            //                                                                    out var locationId,
//            //                                                                    out var location,
...
//            #region ~/tariffs/{party_id}                                 [NonStandard]

//            #region OPTIONS  ~/tariffs/{party_id}            [NonStandard]

//            CommonAPI.AddOCPIMethod(

//                HTTPMethod.OPTIONS,
//                URLPathPrefix + "tariffs/{party_id}",
//                OCPIRequestHandler: request =>
...
//            #region GET      ~/tariffs/{party_id}            [NonStandard]
...
//                                        var allTariffs            = CommonAPI.GetTariffs(partyId).ToArray();
...
//            #region DELETE   ~/tariffs/{party_id}            [NonStandard]
...
//                                        if (addOrUpdateResult.IsSuccessAndDataNotNull(out var resultData))
//                                            return new OCPIResponse.Builder(Request) {
//                                                       StatusCode           = StatusCode.Success,
//                                                       StatusMessage        = "Hello world!",
//                                                       Data                 = resultData.ToJSON(true,
//                                                                                                true,
//                                                                                                true,
//                                                                                                true,
//                                                                                                CustomTariffSerializer,
...
//                                                   StatusCode           = StatusCode.ClientErrors.GenericClientError,
//                                                   StatusMessage        = addOrUpdateResult.ErrorResponse,
//                                                   Data                 = newOrUpdatedTariff.ToJSON(true,
//                                                                                                    true,
//                                                                                                    true,
//                                                                                                    true,
//                                                                                                    CustomTariffSerializer,
...
//                                        var patchResult = await CommonAPI.TryPatchTariff(
//                                                                    existingTariff,
//                                                                    tariffPatch
//                                                                );

//                                        //ToDo: Handle update errors!
//                                        if (patchResult.IsSuccessAndDataNotNull(out var patchedData))
//                                        {
...
//                                        var removeResult = await CommonAPI.RemoveTariff(
//                                                                     partyId.Value,
//                                                                     existingTariff
//                                                                 );
