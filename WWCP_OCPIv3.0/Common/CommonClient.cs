...
namespace cloud.charging.open.protocols.OCPIv3_0
{
    ...
    public partial class CommonClient : ACommonHTTPClient
    {
        ...
        ///// <param name="AccessTokenIsBase64Encoded">Whether the remote access token shall be Base64 encoded.</param>
        ...
        /// <param name="ClientCertificates">The TLS client certificate to use for HTTP authentication.</param>
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        var httpResponse = await NewHTTPClient.POST(
                                                     remoteURL.Value.Path,
                                                     Credentials.ToJSON().ToUTF8Bytes(JSONFormat),
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (response.Data is not null)
                    {
                        ...
                        SelectedOCPIVersionId  = versionId;
                        RemoteAccessToken            = response.Data.Token;
                        TokenAuth              = HTTPTokenAuthentication.Parse(RemoteAccessToken.ToString().ToBase64());
