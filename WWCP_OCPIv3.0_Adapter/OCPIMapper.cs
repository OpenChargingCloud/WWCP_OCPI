...
namespace cloud.charging.open.protocols.OCPIv3_0
{
    ...
    public static class OCPIMapper
    {
        ...
        public static Location_Id ToOCPI(this WWCP.ChargingPool_Id ChargingPoolId)
            ...
            => Location_Id.Parse(ChargingPoolId.ToString());


        public static Location_Id? ToOCPI(this WWCP.ChargingPool_Id? ChargingPoolId)

            => ChargingPoolId.HasValue
                   ? Location_Id.TryParse(ChargingPoolId.Value.ToString())
                   : null;

        #endregion

        #region ToOCPI(this ChargingStationId)

        public static ChargingStation_Id ToOCPI(this WWCP.ChargingStation_Id ChargingStationId)

            => ChargingStation_Id.Parse(ChargingStationId.ToString());


        public static ChargingStation_Id? ToOCPI(this WWCP.ChargingStation_Id? ChargingStationId)

            => ChargingStationId.HasValue
                   ? ChargingStation_Id.TryParse(ChargingStationId.Value.ToString())
                   : null;
        ...
        public static IEnumerable<Facilities> ToOCPI(this IEnumerable<WWCP.Facilities> Facilities)
        {
            ...
            foreach (var facility in Facilities)
            {
                ...
                switch (facility.ToString())
                {
                    ...
                    case "HOTEL":           facilities.Add(OCPIv3_0.Facilities.HOTEL);            break;
                    case "RESTAURANT":      facilities.Add(OCPIv3_0.Facilities.RESTAURANT);       break;
                    case "CAFE":            facilities.Add(OCPIv3_0.Facilities.CAFE);             break;
                    case "MALL":            facilities.Add(OCPIv3_0.Facilities.MALL);             break;
                    case "SUPERMARKET":     facilities.Add(OCPIv3_0.Facilities.SUPERMARKET);      break;
                    case "SPORT":           facilities.Add(OCPIv3_0.Facilities.SPORT);            break;
                    case "RECREATION_AREA": facilities.Add(OCPIv3_0.Facilities.RECREATION_AREA);  break;
                    case "NATURE":          facilities.Add(OCPIv3_0.Facilities.NATURE);           break;
                    case "MUSEUM":          facilities.Add(OCPIv3_0.Facilities.MUSEUM);           break;
                    case "BIKE_SHARING":    facilities.Add(OCPIv3_0.Facilities.BIKE_SHARING);     break;
                    case "BUS_STOP":        facilities.Add(OCPIv3_0.Facilities.BUS_STOP);         break;
                    case "TAXI_STAND":      facilities.Add(OCPIv3_0.Facilities.TAXI_STAND);       break;
                    case "TRAM_STOP":       facilities.Add(OCPIv3_0.Facilities.TRAM_STOP);        break;
                    case "METRO_STATION":   facilities.Add(OCPIv3_0.Facilities.METRO_STATION);    break;
                    case "TRAIN_STATION":   facilities.Add(OCPIv3_0.Facilities.TRAIN_STATION);    break;
                    case "AIRPORT":         facilities.Add(OCPIv3_0.Facilities.AIRPORT);          break;
                    case "PARKING_LOT":     facilities.Add(OCPIv3_0.Facilities.PARKING_LOT);      break;
                    case "CARPOOL_PARKING": facilities.Add(OCPIv3_0.Facilities.CARPOOL_PARKING);  break;
                    case "FUEL_STATION":    facilities.Add(OCPIv3_0.Facilities.FUEL_STATION);     break;
                    case "WIFI":            facilities.Add(OCPIv3_0.Facilities.WIFI);             break;
        ...
        public static Location? ToOCPI(this WWCP.IChargingPool                              ChargingPool,
                                       WWCPChargingStationId_2_ChargingStationId_Delegate?  CustomChargingStationIdConverter,
                                       ...
                                       WWCP.IncludeEVSEIdDelegate?                          IncludeEVSEIds              = null)
        {
            ...
            var includeChargingStationIds  = IncludeChargingStationIds ?? (chargingStationId => true);
            ...
            try
            {
                ...
                foreach (var station in ChargingPool.Where(station => includeChargingStationIds(station.Id)))
                {

                    var ocpiEVSE = station.ToOCPI(CustomChargingStationIdConverter,
                                                  CustomEVSEUIdConverter,
                                                  CustomEVSEIdConverter,
                ...
                return new Location(
                           ...
                           PartyId:              ChargingPool.Id.OperatorId.ToOCPI(),
                           Id:                   ChargingPool.Id.ToOCPI(),
                           VersionId:            1,
                                                   ...
                                                   WWCP.IncludeEVSEIdDelegate?                          IncludeEVSEIds              = null)
        {
            ...
            var locations = ChargingPools.ToOCPI(CustomChargingStationIdConverter,
                                                 CustomEVSEUIdConverter,
                                                 CustomEVSEIdConverter,
                                                 out var warnings,
                                                 IncludeChargingStationIds,
                                                   ...
                                                   WWCP.IncludeEVSEIdDelegate?                          IncludeEVSEIds              = null)
        {
            ...
            foreach (var chargingPool in ChargingPools)
            {
                ...
                try
                {
                    ...
                    var chargingPool2 = chargingPool.ToOCPI(CustomChargingStationIdConverter,
                                                            CustomEVSEUIdConverter,
                                                            CustomEVSEIdConverter,
                                                            out var warning,
                                                            IncludeChargingStationIds,
        ...
        #region ToOCPI(this ChargingStation,  ref Warnings, IncludeEVSEIds = null)

        public static ChargingStation? ToOCPI(this WWCP.IChargingStation                           ChargingStation,
                                              WWCPChargingStationId_2_ChargingStationId_Delegate?  CustomChargingStationIdConverter,
                                              WWCPEVSEId_2_EVSEUId_Delegate?                       CustomEVSEUIdConverter,
                                              WWCPEVSEId_2_EVSEId_Delegate?                        CustomEVSEIdConverter,
                                              ref List<Warning>                                    Warnings,
                                              WWCP.IncludeEVSEIdDelegate?                          IncludeEVSEIds   = null)
        {
            ...
            var location = ChargingStation.ToOCPI(CustomChargingStationIdConverter,
                                                  CustomEVSEUIdConverter,
                                                  CustomEVSEIdConverter,
                                                  out var warnings,
                                                  IncludeEVSEIds);
        ...
        #region ToOCPI(this ChargingStation,  out Warnings, IncludeEVSEIds = null)
                                              ...
                                              WWCP.IncludeEVSEIdDelegate?                          IncludeEVSEIds   = null)
        {
            ...
            if (ChargingStation.Operator is null)
            {
                warnings.Add(Warning.Create("The given charging location must have a valid charging station operator!"));
                Warnings = warnings;
                return null;
            ...
            {
                warnings.Add(Warning.Create($"Could not convert the given charging station '{ChargingStation.Id}' to OCPI: {ex.Message}"));
                Warnings = warnings;
            }
        ...
        #region ToOCPI(this ChargingStations, ref Warnings, IncludeEVSEIds = null)

        public static IEnumerable<ChargingStation> ToOCPI(this IEnumerable<WWCP.ChargingStation>               ChargingStations,
                                                          WWCPChargingStationId_2_ChargingStationId_Delegate?  CustomChargingStationIdConverter,
                                                          WWCPEVSEId_2_EVSEUId_Delegate?                       CustomEVSEUIdConverter,
                                                          WWCPEVSEId_2_EVSEId_Delegate?                        CustomEVSEIdConverter,
                                                          ref List<Warning>                                    Warnings,
                                                          WWCP.IncludeEVSEIdDelegate?                          IncludeEVSEIds   = null)
        {
            ...
            var locations = ChargingStations.ToOCPI(CustomChargingStationIdConverter,
                                                    CustomEVSEUIdConverter,
                                                    CustomEVSEIdConverter,
                                                    out var warnings,
                                                    IncludeEVSEIds);
        ...
        #region ToOCPI(this ChargingStations, out Warnings, IncludeEVSEIds = null)
                                                          ...
                                                          WWCP.IncludeEVSEIdDelegate?                          IncludeEVSEIds   = null)
        {
            ...
            var warnings   = new List<Warning>();
            var locations  = new HashSet<ChargingStation>();

            foreach (var chargingPool in ChargingStations)
            {
                                        ...
                                        out IEnumerable<Warning>      Warnings)
        {
            ...
            try
            {
                ...
                return new Connector(
                           ...
                           MaxVoltage:              (EVSE.AverageVoltage.HasValue && EVSE.AverageVoltage.Value.Value != 0
                                                        ? powerType.Value switch {
                                  ...
                                  out IEnumerable<Warning>                             Warnings)
        {
            ...
            var warnings  = new List<Warning>();
            var cdr       = ChargeDetailRecord.ToOCPI(CustomChargingStationIdConverter,
                                                      CustomEVSEUIdConverter,
                                                      CustomEVSEIdConverter,
                                  ...
                                  ref List<Warning>                                    Warnings)
        {
            ...
            try
            {
                ...
                var filteredLocation = ChargeDetailRecord.ChargingPool.ToOCPI(CustomChargingStationIdConverter,
                                                                              CustomEVSEUIdConverter,
                                                                              CustomEVSEIdConverter,
                                                                              ref Warnings,
                                                                              null,
