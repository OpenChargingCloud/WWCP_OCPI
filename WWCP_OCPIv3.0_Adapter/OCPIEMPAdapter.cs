...
namespace cloud.charging.open.protocols.OCPIv3_0
{
...

    {
        ...
        public Task<POIDataPull<WWCP.EVSE>> PullEVSEData(DateTimeOffset? LastCall = null, GeoCoordinate? SearchCenter = null, float DistanceKM = 0, EMobilityProvider_Id? ProviderId = null, IEnumerable<ChargingStationOperator_Id>? OperatorIdFilter = null, IEnumerable<Country>? CountryCodeFilter = null, DateTimeOffset? Timestamp = null, EventTracking_Id? EventTrackingId = null, TimeSpan? RequestTimeout = null, CancellationToken CancellationToken = default)
        {
            throw new NotImplementedException();
        }
