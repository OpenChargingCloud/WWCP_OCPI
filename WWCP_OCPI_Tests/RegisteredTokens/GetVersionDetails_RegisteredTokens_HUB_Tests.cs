...
namespace cloud.charging.open.protocols.OCPI.UnitTests
{
...

    {
        ...
        #region HUB1_GetVersionDetails_v2_3_0_fromCPO1_viaOCPIv2_3_0__RegisteredToken_Test1()

        /// <summary>
        /// HUB #1 asks CPO #1 for its OCPI v2.3.0 version details details via OCPI v2.3.0!
        /// </summary>
        [Test]
        public async Task HUB1_GetVersionDetails_v2_3_0_fromCPO1_viaOCPIv2_3_0__RegisteredToken_Test1()
        {

            var graphDefinedCPO1 = hub1HUBAPI_v2_3_0?.GetCPOClient(
                                       CountryCode: CountryCode.Parse("DE"),
                                       PartyId:     Party_Id.   Parse("GEF")
                                   );
