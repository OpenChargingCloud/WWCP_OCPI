                       ...
                       IComparable
    {
                              ...
                              CustomJObjectSerializerDelegate<SignedValue>?           CustomSignedValueSerializer            = null)
        {
            ...
            var json = JSONObject.Create(
                           ...
                           TotalFixedCosts is not null
                               ? new JProperty("total_fixed_cost",             TotalFixedCosts.               ToJSON(CustomPriceSerializer,
                                                                                                                     CustomTaxAmountSerializer))
                               : null,
                           ...
                           TotalTimeCost is not null
                               ? new JProperty("total_time_cost",              TotalTimeCost.                 ToJSON(CustomPriceSerializer,
                                                                                                                     CustomTaxAmountSerializer))
                               : null,
                           ...
                           TotalParkingCost is not null
                               ? new JProperty("total_parking_cost",           TotalParkingCost.              ToJSON(CustomPriceSerializer,
                                                                                                                     CustomTaxAmountSerializer))
                               : null,

                           TotalReservationCost is not null
                               ? new JProperty("total_reservation_cost",       TotalReservationCost.          ToJSON(CustomPriceSerializer,
                                                                                                                     CustomTaxAmountSerializer))
                               : null,
        ...
        public Boolean Equals(CDR? CDR)
            ...
            ((!EnergyMeterId.                 HasValue    && !CDR.EnergyMeterId.                 HasValue)  ||
             ...
             ((TotalFixedCosts          is     null &&  CDR.TotalFixedCosts          is     null)  ||
              (TotalFixedCosts          is not null &&  CDR.TotalFixedCosts          is not null && TotalFixedCosts.               Equals(CDR.TotalFixedCosts               ))) &&

             ((TotalEnergyCost          is     null &&  CDR.TotalEnergyCost          is     null)  ||
              (TotalEnergyCost          is not null &&  CDR.TotalEnergyCost          is not null && TotalEnergyCost.               Equals(CDR.TotalEnergyCost               ))) &&

             ((TotalTimeCost            is     null &&  CDR.TotalTimeCost            is     null)  ||
              (TotalTimeCost            is not null &&  CDR.TotalTimeCost            is not null && TotalTimeCost.                 Equals(CDR.TotalTimeCost                 ))) &&
            ...
            ((!TotalParkingTime.        HasValue    && !CDR.TotalParkingTime.        HasValue)  ||
             ...
             ((TotalParkingCost         is     null &&  CDR.TotalParkingCost         is     null)  ||
              (TotalParkingCost         is not null &&  CDR.TotalParkingCost         is not null && TotalParkingCost.              Equals(CDR.TotalParkingCost              ))) &&

             ((TotalReservationCost     is     null &&  CDR.TotalReservationCost     is     null)  ||
              (TotalReservationCost     is not null &&  CDR.TotalReservationCost     is not null && TotalReservationCost.          Equals(CDR.TotalReservationCost          ))) &&
