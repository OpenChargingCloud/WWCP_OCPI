...
namespace org.GraphDefined.WWCP.OCPIv2_0.Tools
{
    ...
    public static class OCPIMapper
    {
        ...
        public static WWCP.EVSEStatusType AsWWCPEVSEStatus(this OCPIv2_0.EVSEStatusType EVSEStatus)
        {

            switch (EVSEStatus)
            {

                case OCPIv2_0.EVSEStatusType.Available:
                    return WWCP.EVSEStatusType.Available;

                case OCPIv2_0.EVSEStatusType.Blocked:
                    return WWCP.EVSEStatusType.OutOfService;

                case OCPIv2_0.EVSEStatusType.Charging:
                    return WWCP.EVSEStatusType.Charging;

                case OCPIv2_0.EVSEStatusType.Inoperative:
                    return WWCP.EVSEStatusType.OutOfService;

                case OCPIv2_0.EVSEStatusType.OutOfOrder:
                    return WWCP.EVSEStatusType.Faulted;

                case OCPIv2_0.EVSEStatusType.Planned:
                    return WWCP.EVSEStatusType.Planned;

                case OCPIv2_0.EVSEStatusType.Removed:
                    return WWCP.EVSEStatusType.UnknownEVSE;

                case OCPIv2_0.EVSEStatusType.Reserved:
        ...
        /// <param name="EVSEStatus">An OCPI v2.0 EVSE status.</param>
        /// <returns>The corresponding WWCP EVSE status.</returns>
        public static OCPIv2_0.EVSEStatusType AsOCPIEVSEStatus(this WWCP.EVSEStatusType EVSEStatus)
        {
            ...
            switch (EVSEStatus)
            {
                ...
                case WWCP.EVSEStatusType.Planned:
                    return OCPIv2_0.EVSEStatusType.Planned;

                case WWCP.EVSEStatusType.InDeployment:
                    return OCPIv2_0.EVSEStatusType.Planned;

                case WWCP.EVSEStatusType.Available:
                    return OCPIv2_0.EVSEStatusType.Available;

                case WWCP.EVSEStatusType.Charging:
                    return OCPIv2_0.EVSEStatusType.Charging;

                case WWCP.EVSEStatusType.Faulted:
                    return OCPIv2_0.EVSEStatusType.OutOfOrder;

                case WWCP.EVSEStatusType.OutOfService:
                    return OCPIv2_0.EVSEStatusType.Inoperative;

                case WWCP.EVSEStatusType.Offline:
                    return OCPIv2_0.EVSEStatusType.Unknown;

                case WWCP.EVSEStatusType.Reserved:
                    return OCPIv2_0.EVSEStatusType.Reserved;

                case WWCP.EVSEStatusType.Other:
                    return OCPIv2_0.EVSEStatusType.Unknown;

                case WWCP.EVSEStatusType.UnknownEVSE:
                    return OCPIv2_0.EVSEStatusType.Removed;
