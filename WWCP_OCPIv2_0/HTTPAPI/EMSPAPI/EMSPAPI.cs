...
namespace org.GraphDefined.WWCP.OCPIv2_0.HTTP
{
    ...
    public class EMSPAPI : GenericAPI
    {
        ...
        public EMSPAPI(RoamingNetwork    RoamingNetwork,
            ...
            : base(RoamingNetwork,
                   ...
                   URIPrefix,
                   ResourceName => typeof(EMSPAPI).Assembly.GetManifestResourceStream("org.GraphDefined.WWCP.OCPIv2_0.HTTPAPI.EMSPAPI.HTTPRoot." + ResourceName),

                   ServiceName,
                   APIEMailAddress,
                   null,//OpenPGP.ReadPublicKeyRing(typeof(EMSPAPI).Assembly.GetManifestResourceStream("org.GraphDefined.WWCP.OCPIv2_0.HTTPAPI.GenericAPI.HTTPRoot.robot@offenes-jena_pubring.gpg")),
                   APISecretKeyRing,
                   APIPassphrase,
                   APIAdminEMail,
                   APISMTPClient,
        ...
        public EMSPAPI(RoamingNetwork    RoamingNetwork,
            ...
            : base(RoamingNetwork,
                   ...
                   ServiceName,
                   APIEMailAddress,
                   OpenPGP.ReadPublicKeyRing(typeof(EMSPAPI).Assembly.GetManifestResourceStream("org.GraphDefined.WWCP.OCPIv2_0.HTTPAPI.EMSPAPI.HTTPRoot.About.robot@offenes-jena_pubring.gpg")),
                   APISecretKeyRing,
                   APIPassphrase,
                   APIAdminEMail,
                   APISMTPClient,
